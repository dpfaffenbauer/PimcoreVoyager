...
**Project** - refers to the Pimcore Voyager project and any related repositories maintained by CORS GmbH.

**Contribution** - any type of work that is submitted to the Project, including any modifications or additions to existing
work.

**Submitted** - conveyed to the Project via a pull request, commit, issue, or any form of electronic, written, or verbal
communication with CORS GmbH, contributors or maintainers.

## 1. Grant of Copyright License.

Subject to the terms and conditions of this agreement, You grant to the Project's maintainers, contributors, users and
to CORS GmbH a perpetual, worldwide, non-exclusive, no-charge, royalty-free, irrevocable copyright license to reproduce,
...
Subject to the terms and conditions of this agreement, You grant to the Project's maintainers, contributors, users and
to CORS GmbH a perpetual, worldwide, non-exclusive, no-charge, royalty-free, irrevocable (except as stated in this
